...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sir.photo'
        db.add_column('chamber_sir', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(blank=True, max_length=100, default=datetime.datetime(2013, 7, 28, 0, 0)),
                      keep_default=False)

        # Adding field 'Sir.created_by'
        db.add_column('chamber_sir', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sir.photo'
        db.delete_column('chamber_sir', 'photo')

        # Deleting field 'Sir.created_by'
        db.delete_column('chamber_sir', 'created_by_id')
